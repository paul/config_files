...
"" General colors
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=0   guibg=#ffffff cterm=none gui=none
...
hi SpellBad     ctermfg=15  guifg=#ffffff ctermbg=174 guibg=#800000
hi SpellCap     ctermfg=15  guifg=#ffffff ctermbg=174 guibg=#800000
hi SpellRare    ctermfg=15  guifg=#ffffff ctermbg=174 guibg=#800000
hi SpellLocal   ctermfg=15  guifg=#ffffff ctermbg=174 guibg=#800000
